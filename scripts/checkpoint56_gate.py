"""Fail-closed summary for an exact-revision, fully executed Checkpoint 5/6 CI gate.
...
def main():
    ...
    report = (
        ...
        "Per-provider implementation and provider-readiness evidence is documented in CHECKPOINT_5_6_REPORT.md.\n"
    )
    (destination / "CHECKPOINT_5_6_GATE.txt").write_text(report, encoding="utf-8")
