...
const allowedRoots = new Set(["leads", "contacts", "companies", "deals", "tasks", "notes", "activities", "campaigns", "integrations", "operations", "foundation", "users", "tenants", "workforce", "automation"]);
